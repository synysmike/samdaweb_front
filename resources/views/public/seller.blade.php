...
<div class="container mx-auto px-4 py-8 max-w-6xl">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-8">
            <h1 class="text-3xl font-bold text-white">Seller Page</h1>
            <p class="text-blue-100 mt-2">Manage your product categories</p>
        </div>
        ...
        <div class="p-6 border-t border-gray-200">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-semibold text-gray-800">Product Subcategories</h2>
...
<script>
    ...
    function renderSubCategories() {
        ...
        tbody.innerHTML = subcategories.map(subcategory => {
            ...
            const categoryName = getCategoryName(subcategory.parent_id ?? subcategory.category_id ?? '');
    ...
    // Close subcategory modal on outside click
