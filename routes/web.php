...
Route::middleware(['auth.session'])->group(function () {
    ...
    Route::get('/api/seller/attributes', [SellerController::class, 'getAttributes'])->name('api.seller.attributes');
    Route::post('/api/seller/attributes/show', [SellerController::class, 'showAttribute'])->name('api.seller.attributes.show');
    Route::post('/api/seller/attributes/store', [SellerController::class, 'storeAttribute'])->name('api.seller.attributes.store');
    Route::post('/api/seller/attributes/delete', [SellerController::class, 'deleteAttribute'])->name('api.seller.attributes.delete');
    Route::post('/api/seller/attribute-values', [SellerController::class, 'getAttributeValues'])->name('api.seller.attribute-values');
    Route::post('/api/seller/attribute-values/show', [SellerController::class, 'showAttributeValue'])->name('api.seller.attribute-values.show');
    Route::post('/api/seller/attribute-values/store', [SellerController::class, 'storeAttributeValue'])->name('api.seller.attribute-values.store');
    Route::post('/api/seller/attribute-values/delete', [SellerController::class, 'deleteAttributeValue'])->name('api.seller.attribute-values.delete');
